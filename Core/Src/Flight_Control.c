...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 1.7;               	//Gain setting for the roll P-controller (1.4) 			- (1.6)
float pid_i_gain_roll = 0.006;              	//Gain setting for the roll I-controller (0.05)		- (0.005)
float pid_d_gain_roll = 60;                	//Gain setting for the roll D-controller (15)			- (50)
int pid_max_roll = 400;                   	//Maximum output of the PID-controller (+/-) (400)

float pid_p_gain_pitch = 1.7;    			//Gain setting for the pitch P-controller (1.4)			- (1.6)
float pid_i_gain_pitch = 0.006;  			//Gain setting for the pitch I-controller (0.05)		- (0.005)
float pid_d_gain_pitch = 60;  				//Gain setting for the pitch D-controller (15)			- (50)
